...
.endc
"}
C {devices/gnd.sym} 290 40 0 1 {name=l1 lab=GND}
C {devices/lab_wire.sym} 310 -110 0 1 {name=p1 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 300 -70 0 1 {name=p4 sig_type=std_logic lab=LOp}
C {devices/lab_wire.sym} 300 -50 0 1 {name=p5 sig_type=std_logic lab=LOn}
C {devices/lab_wire.sym} 300 -30 0 1 {name=p6 sig_type=std_logic lab=RFp}
C {devices/lab_wire.sym} 300 -10 0 1 {name=p7 sig_type=std_logic lab=RFn}
C {sky130_fd_pr/corner.sym} -50 -420 0 0 {name=CORNER only_toplevel=true corner=tt}
C {gill_cell.sym} 120 -40 0 0 {name=x1}
...
C {devices/lab_wire.sym} 300 -90 0 1 {name=p17 sig_type=std_logic lab=IF
}
