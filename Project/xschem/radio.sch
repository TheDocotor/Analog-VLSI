...
C {gill_cell.sym} -1280 -310 0 0 {name=x1}
...
C {/home/renslow/Documents/ece5120/hw06/xschem/lna.sym} -1290 -510 0 0 {name=x2}
...
C {demod.sym} -560 -480 0 0 {name=x4}
...
C {bandgap.sym} -1290 -130 0 0 {name=x5}
